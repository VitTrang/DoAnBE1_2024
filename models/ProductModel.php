...
class ProductModel extends Model
{
    ...
    public function linksLimitProduct($url, $total, $perPage, $page)
    {
        ...
        if ($totallink != 1 && $totallink != 0) {
            ...
            $link = "<ul class='pagination justify-content-center mt-4'><li class='page-item'><a class='page-link' href=$url&page=1>Trang Đầu</a></li><li class='page-item'><a class='page-link' href=$url&page=$revius><</a></li>";
            ...
            $link = $link . "<li class='page-item'><a class='page-link' href=$url&page=$next>></a></li><li class='page-item'><a class='page-link' href=$url&page=$totallink>Trang Cuối</a></li></nav>";
        }
    ...
    public function getTotalProducts() {
        $sql = parent::$connection->prepare("SELECT COUNT(*) as total FROM product");
        $sql->execute();
